...
import { DashboardPieChart } from "../../../variables/BlueCharts";
    ...
    <>
      <div className="content">
        <Row>
          ...
          <Col lg="4" md="6">
            <Card className="card-stats">
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Total Number of Docks</p>
              ...
              <CardFooter>
                <hr />
                <div className="stats">
                  <i className="tim-icons icon-refresh-01" /> Update total number of Docks in Warehouse
                </div>
              </CardFooter>
            </Card>
          </Col>
            ...
            <Card className="card-stats">
              <CardBody>
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      <p className="card-category">Occupied Docks</p>
              ...
              <CardFooter>
                <hr />
                <div className="stats">
                  <i className="tim-icons icon-refresh-01"  /> Update on Current Occupied Docks
                </div>
              </CardFooter>
            </Card>
          </Col>
          <Col lg="4" md="6">
            <Card className="card-stats">
              ...
              <CardFooter>
                <hr />
                <div className="stats">
                  <i className="tim-icons icon-refresh-01" /> Update on Current available Docks
                </div>
              </CardFooter>
            </Card>
          </Col>
         ...
         >
              <CardHeader>
                <h5 className="card-category"> Dock Utilization</h5>
              </CardHeader>
              <CardBody>
                  ...
                  <Col xs="10" >
                    <div className="chart-area">
                      <Pie 
                        ...
                        options={DashboardPieChart.options}
                      />
                    </div>
                  </Col>
                  </Row>
          ...
          <Col className="mr-auto" md="12" xs="12" lg="4">
